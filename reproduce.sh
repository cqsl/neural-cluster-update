...
for beta in $(seq 0.1 0.1 0.3) $(seq 0.4 0.01 0.5) $(seq 0.6 0.1 1.0); do
    ...
    echo train.py "$args"
    echo sample_cluster.py "$args" --batch_size 1000 --max_step 100000 # NCUS
    echo sample_cluster.py "$args" --batch_size 1000 --max_step 100000 --k_type const --k_param 256 # NGUS
    echo sample_raw.py "$args" --batch_size 1000 --max_step 100000 # NGU and NIS
done
